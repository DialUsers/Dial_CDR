...
This module is used for finding the uncovered pop in the Model 3.
"""
...
GVH_ADM_Name='MWI_adm3.shp'
GVH_ADM=shp.read_shape_data_file(GVH_Dir,GVH_ADM_Name)

# Reading Weights without Disease Ranking
Dis_Dir="F:/Inputs/"
Dis_Rank_Name='TA_Weights_With_Disease_Ranking'
Dis_Rank=pds.read_csv_data_file(Dis_Dir,Dis_Rank_Name)

################### Model 3 Year 1 Attriburtes and Tables ###########################

# Model 3 Paths for the Input files
Dir_Year_1="F:/Model_3/Year_1/"
...
# Various Attributes for the Model 3
crs={'init': 'epsg:4326'}
Year_1='2020'
...
# Various Attributes for Likoma Island for Model 3
near_point_Likoma_Year_1=2
clus_size_Likoma_Year_1=1

# Model 3 Paths for the Output files
...
###################Model 3 Year 2 Starts #############################################################
Dir_Year_2="F:/Model_3/Year_2/"
...
######################################## Model 3 Year 3 Starts ########################################
Dir_Year_3="F:/Model_3/Year_3/"
...
######################## MOdel 3 Year 4 Starts ########################################################
Dir_Year_4="F:/Model_3/Year_4/"
