...
################### Model 1 Year 1 Attriburtes and Tables ###########################

# Model 1 Paths for the Input files
Dir_Year_1="F:/Model_1/Year_1/"
...
# Various Attributes for the Model 1
crs={'init': 'epsg:4326'}
Year_1='2020'
...
# Various Attributes for Likoma Island for Model 1
near_point_Likoma_Year_1=2
clus_size_Likoma_Year_1=1

# Model 1 Paths for the Output files
...
Uncover_TA_Name_Year_1="Uncovered_TA_"+Year_1

# Applying Logics
Malawi_Map_year_1=shp.read_shape_data_file(Dir_Year_1, Malawi_Map_Name_Year_1)
Uncover_TA_Year_1=pds.read_csv_data_file(Dir_Year_1, Uncover_TA_Name_Year_1)
...
Demand_Points_Year_1=dp.demand_Points(Uncover_TA_Year_1, Probable_Points_Year_1, GVH_ADM, Existing_Health_Post_Areas, Rank_Min_Year_1, Cluster_Min_Year_1, Year_1, Disease_Flag)
...
###################Model 1 Year 2 Starts #############################################################
Dir_Year_2="F:/Model_1/Year_2/"
...
Demand_Points_Year_2=dp.demand_Points(Uncover_TA_Year_2, Probable_Points_Year_2, GVH_ADM, Covered_Areas_Year_1, Rank_Min_Year_2, Cluster_Min_Year_2, Year_2, Disease_Flag)
...
######################################## Model 1 Year 3 Starts ########################################
Dir_Year_3="F:/Model_1/Year_3/"
...
Demand_Points_Year_3=dp.demand_Points(Uncover_TA_Year_3, Probable_Points_Year_3, GVH_ADM, Covered_Areas_Year_2, Rank_Min_Year_3, Cluster_Min_Year_3, Year_3, Disease_Flag)
...
# Calulate overall covered Area
Covered_Areas_Year_2=Covered_Areas_Year_2[['Area', 'Country', 'District', 'Pop_Percen', 'TA_NAMES', 'Type', 'geometry']]
...
######################## MOdel 1 Year 4 Starts ########################################################
Dir_Year_4="F:/Model_1/Year_4/"
...
Demand_Points_Year_4=dp.demand_Points(Uncover_TA_Year_4, Probable_Points_Year_4, GVH_ADM, Covered_Areas_Year_3, Rank_Min_Year_4, Cluster_Min_Year_4, Year_4, Disease_Flag)
